...
void BoardBuilding()
{
    ...
    //Define the coordinates on the chess-board.
    array[0][0] = "９";
    array[0][1] = "８";
    array[0][2] = "７";
    array[0][3] = "６";
...
void redMove()
{
    ...
    printf("\n\033[31m[RED]\033[0m Please enter the coordinates of the piece you want to move:\n");
    scanf("%d",&inp1);    
    ...
    {   
        ...
        printf("\033[31m[RED]\033[0m Please enter the coordinates of the place you want to put the piece onto:\n");
        scanf("%d %d",&inp3,&inp4);
...
void blueMove()
{
    ...
    printf("\n\033[34m[Blue]\033[0m Please enter the coordinates of the piece you want to move:\n");
    scanf("%d",&inp1);
    ...
    {   
        ...
        printf("\033[34m[Blue]\033[0m Please enter the coordinates of the place you want to put the piece onto:\n");
        scanf("%d %d",&inp3,&inp4);
